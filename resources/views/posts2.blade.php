        ...
        <form class="max-w-lg">
            ...
            <div class="relative rounded-md shadow-sm">
                ...
                <input id="search" name="search" value="{{ request('search') }}"
                       class="form-input block w-full pl-10 sm:text-sm sm:leading-5" placeholder="Search..."/>
            </div>
        </form>
                            ...
                            <tr class="bg-white">
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 text-sm leading-5">
                                    <div class="flex items-center">
                                        ...
                                        @if ($post->score)
                                            <span
                                                class="ml-1 px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">
