                    ...
                    <table class="min-w-full">
                        ...
                        <tr>
                            <th class="w-1/2 px-6 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                                <div class="flex items-center">
                                    <a class="hover:underline"
                                       href="{{ route('features2', ['sort' => 'title', 'direction' => request('sort') === 'title' && request('direction') === 'asc' ? 'desc' : 'asc']) }}">Title</a>
                            ...
                            <th class="w-1/4 px-6 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                                <div class="flex items-center">
                                    <a class="hover:underline"
                                       href="{{ route('features2', ['sort' => 'status', 'direction' => request('sort') === 'status' && request('direction') === 'asc' ? 'desc' : 'asc']) }}">Status</a>
                            ...
                            <th class="w-1/4 px-6 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                                <div class="flex items-center">
                                    <a class="hover:underline"
                                       href="{{ route('features2', ['sort' => 'activity', 'direction' => request('sort') === 'activity' && request('direction') === 'asc' ? 'desc' : 'asc']) }}">Activity</a>
                                ...
                                <td class="px-6 py-4 border-b border-gray-200">
                                    <div class="flex items-center text-sm text-green-500">
                                        ...
                                        <div class="ml-3 flex items-center">
                                            <svg class="fill-current w-3 h-3 mt-2px" viewBox="0 0 40 40" width="40"
                                                 height="40"><title>Exported from Streamline App
                                                    (https://app.streamlineicons.com)</title>
