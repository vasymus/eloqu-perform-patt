                    ...
                    <table class="min-w-full">
                        ...
                        <tr>
                            <th class="w-1/2 px-6 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                                <div class="flex items-center">
                                    <a class="hover:underline"
                                       href="{{ route('features', ['sort' => 'title', 'direction' => request('sort') === 'title' && request('direction') === 'asc' ? 'desc' : 'asc']) }}">Title</a>
                            ...
                            <th class="w-1/4 px-6 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                                <div class="flex items-center">
                                    <a class="hover:underline"
                                       href="{{ route('features', ['sort' => 'status', 'direction' => request('sort') === 'status' && request('direction') === 'asc' ? 'desc' : 'asc']) }}">Status</a>
                            ...
                            <th class="w-1/4 px-6 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">
                                <div class="flex items-center">
                                    <a class="hover:underline"
                                       href="{{ route('features', ['sort' => 'activity', 'direction' => request('sort') === 'activity' && request('direction') === 'asc' ? 'desc' : 'asc']) }}">Activity</a>
